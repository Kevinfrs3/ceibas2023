...
const services_data = [
  { name: "Talento Humano", icon: "industries" },
  { name: "Direccionamiento \n estratégico y planeación", icon: "validation" },
  { name: "Gestión con \n  valores para resultados", icon: "engineering" },
  { name: "Evaluación \n de resultados", icon: "management" },
  { name: "Información \n y comunicación", icon: "manufacturing" },
  { name: "Gestión del conocimiento\n y la innovación ", icon: "technical" },
  { name: "Control interno", icon: "process" }
];

 ...
 * Copyright jQuery Foundation and other contributors; Licensed MIT */ !(function (
        ...
        (t.fn.position = function (e) {
          ...
          return (
            ...
            this.each(function () {
              ...
              "right" === e.my[0]
                ? (P.left -= l)
                : "center" === e.my[0] && (P.left -= l / 2),
                "bottom" === e.my[1]
                  ? (P.top -= u)
                  : "center" === e.my[1] && (P.top -= u / 2),
                (P.left += T[0]),
                (P.top += T[1]),
                i || ((P.left = o(P.left)), (P.top = o(P.top))),
                (a = { marginLeft: b, marginTop: $ }),
                t.each(["left", "top"], function (i, s) {
                  t.ui.position[k[i]] &&
                    t.ui.position[k[i]][s](P, {
                      targetWidth: f,
                      targetHeight: g,
                      elemWidth: l,
                      elemHeight: u,
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _refreshItems: function (e) {
        ...
        for (i = u.length - 1; i >= 0; i--)
          for (s = 0, a = u[i][1], l = (r = u[i][0]).length; s < l; s++)
  ...
  t.widget("ui.button", {
          ...
          for (k = 0, x = "", this.maxRows = 4; k < K[1]; k++) {
            ...
            for (
              P += T + "</tr></thead><tbody>",
                ...
                M = Math.ceil(
                  ((z = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7) + S) / 7
                ),
                H = X && this.maxRows > M ? this.maxRows : M,
                this.maxRows = H,
                ...
                (N = m ? m.apply(t.input ? t.input[0] : null, [A]) : [!0, ""]),
                  ...
                  (E +=
                    ...
                    ((A.getTime() === C.getTime() &&
                      Z === t.selectedMonth &&
                      t._keyEvent) ||
                    ($.getTime() === A.getTime() && $.getTime() === C.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (F
    ...
    t.widget("ui.tabs", {
      ...
      _isLocal:
        ...
        function (t) {
          var e, i;
          (e = (t = t.cloneNode(!1)).href.replace(w, "")),
  ...
  (t.effects = { effect: {} }),
              ...
              ? (s instanceof o
                  ...
                  : c(a, function (e, i) {
                      ...
                      c(i.props, function (t, e) {
                        ...
                        l[n] &&
                          0 > t.inArray(null, l[n].slice(0, 3)) &&
                          ((l[n][3] = 1), i.from && (l._rgba = i.from(l[n])));
                    }),
                this)
              : void 0;
          },
        ...
        function (e, i) {
          t.fx.step[i] = function (t) {
            (("none" === t.end || t.setAttr) && (1 !== t.pos || t.setAttr)) ||
              (C.style(t.elem, i, t.end), (t.setAttr = !0));
          };
        }
      ),
        t.fn.addBack ||
      ...
      t.extend(t.effects, {
        ...
        restore: function (t, e) {
          ...
          for (s = 0; s < e.length; s++)
            null !== e[s] &&
              (void 0 === (i = t.data(k + e[s])) && (i = ""), t.css(e[s], i));
        },
    ...
    (t.effects.effect.bounce = function (e, i) {
      ...
      for (
        ...
        ((n = {})[v] = (b ? "-=" : "+=") + d),
          ...
          (d = l ? 2 * d : d / 2);
      l &&
        (((n = { opacity: 0 })[v] = (b ? "-=" : "+=") + d), a.animate(n, g, m)),
        a.queue(function () {
          l && a.hide(),
            t.effects.restore(a, r),
            t.effects.removeWrapper(a),
        ...
        y > 1 && $.splice.apply($, [1, 0].concat($.splice(y, f + 1))),
        a.dequeue();
    }),
    ...
    (t.effects.effect.explode = function (e, i) {
      ...
      for (s = 0; s < l; s++)
        for (n = 0, a = p.top + s * g, h = s - (l - 1) / 2; n < c; n++)
          (o = p.left + n * f),
            (r = n - (c - 1) / 2),
            u
              .clone()
    ...
    (t.effects.effect.size = function (e, i) {
      ...
      "show" === d && a.show(),
        ...
        "toggle" === e.mode && "show" === d
          ...
          : ((a.from = e.from || ("show" === d ? b : s)),
            (a.to = e.to || ("hide" === d ? b : s))),
        (o = {
